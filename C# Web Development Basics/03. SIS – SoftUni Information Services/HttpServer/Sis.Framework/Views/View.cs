namespace Sis.Framework.Views
{
    ...
    public class View : IRenderable
    {
        ...
        private readonly string fullHtmlContext;

        public View(string fullHtmlContext)
        {
            this.fullHtmlContext = fullHtmlContext;
        }

        public string Render() => this.fullHtmlContext;
